...
const AddDonationsPage = () => {
  const [description, setDescription] = useState("");
  const [category, setCategory] = useState("priority request");
  ...
  const addBlog = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.post(`${import.meta.env.VITE_SERVER_URL}/donations`, {
        img: image,
        title,
        description,
        category,
...
export default AddDonationsPage;
